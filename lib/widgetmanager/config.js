...
this.Config = (function() {
  ...
  var wrtHome;
	if(process.platform == 'android') {
		// enable to serve widget contents via HTTP until content provider protocol in place in WRT
		wrtHome = '/data/data/org.webinos.android/node_modules/webinos/node_modules/webinos-pzp/web_root/apps';
		//  wrtHome = '/data/data/org.webinos.android/wrt';
  }
    ...
    var webinosPath = require("webinos-utilities").webinosPath.webinosPath();
		wrtHome = path.join(webinosPath,'wrt/widgetStore');
	} else {
